  ...
  return (
    <main>
      ...
      <div className="flex justify-center my-8">
        <Image src="/tiposdeemisiones.svg" alt="Visualizacion de datos" width={1400} height={600} />
      </div>
    ...
    */}
      ...
      <div className="flex justify-center my-8">
        <Image src="/potencias.svg" alt="Visualizacion de datos" width={1800} height={500} />
      </div>
